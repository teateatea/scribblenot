...
mod tests {
    ...
    fn flat_block_box_variant_has_id() {
        ...
        let block = FlatBlock::Box { id: "box1".to_string() };
        match &block {
    ...
    fn flat_block_group_variant_has_id() {
        let block = FlatBlock::Group { id: "grp1".to_string() };
        match &block {
    ...
    fn flat_block_section_variant_has_id() {
        let block = FlatBlock::Section { id: "sec1".to_string() };
        match &block {
    ...
    fn flat_block_field_variant_has_id() {
        let block = FlatBlock::Field { id: "fld1".to_string() };
        match &block {
    ...
    fn flat_block_options_list_variant_has_id() {
        let block = FlatBlock::OptionsList { id: "opt1".to_string() };
        match &block {
    ...
    fn flat_file_holds_list_of_blocks() {
        ...
        let file = FlatFile {
            blocks: vec![
                FlatBlock::Box { id: "b1".to_string() },
                FlatBlock::Section { id: "s1".to_string() },
            ],
        };
...
"#;
    ...
    fn flat_block_id_is_string() {
        ...
        let block = FlatBlock::Field { id: String::from("field_id") };
