...
**C** `section-body-schema` — add explicit authored section `body:` typing and tighten remaining loader reference validation while that schema surface is open (#22, #3) — safest third branch beside A and B; `#29` should wait because it overlaps A's input/navigation wiring and B's modal row rendering
