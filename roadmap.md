...
## Now
**A** `test-safety` — test infrastructure quality and clipboard import safety (#17, #5, #20)
**B** `modal-correctness` — confirmed-slot scoping and modal visual corrections; safe to open alongside A (#31, #27, #32, #33, #35) — #23 is next by priority but conflicts with #31 on `src/app.rs`
