...
- [ ] **#52** Extract hard-coded boilerplate strings from note.rs into editable YML data files *(52.1 implemented)* *(52.2 implemented)* *(52.3 implemented)* *(52.4 implemented)*
  [D:62 C:72]
